...
# script in s4example.scripts.<foo>.main()
setup_opts["entry_points"] = {
    "console_scripts": ["s4example_testscript = s4example.scripts.testscript:main"]
}
...
setup_opts["url"] = "https://github.com/CMB-S4/s4example"
...
ext_modules = [
    Extension(
        "s4example._s4example",
        ["s4example/fake.cpp", "s4example/_s4example.cpp"],
        include_dirs=["s4example"],
        language="c++",
    )
]
